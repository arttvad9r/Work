...
11. Check calendar visual states: entry glyph in filled cells, monthly income as the summary's primary value, bold report total with error color only when negative, empty-month prompt opening today's editor.
