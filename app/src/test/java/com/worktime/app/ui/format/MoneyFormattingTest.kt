...
class MoneyFormattingTest {
    ...
    @Test
    fun `whole amount formatter rounds calendar fractions and uses stable space grouping`() {
        ...
        assertEquals("4 810", formatWholeAmountMicros(4_810_000_000L, Locale("ru")))
    }
}
